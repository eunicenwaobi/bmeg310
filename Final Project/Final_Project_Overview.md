...
2. **Final Report** 
    ...
    * **HOW TO SUBMIT PROJECT:** Please enter the link to your project github repo and your group presentation here: https://docs.google.com/spreadsheets/d/1dvIyYv8hpiNfveQm_6OqW60N77yi55KOMDLGeZxScS0/edit?usp=sharing - It is important to note that the project repo should be **private** and the presentation videos should be only available through the provided link (i.e., they should not be shared with public). In Youtube, this can be done by making your video **Unlisted**: please see the following link.  
